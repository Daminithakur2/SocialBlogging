    ...
    <>
      ...
      <div className='background'>
        <div className='cover-image'>
          <img className='cover-img' src={`http://localhost:5000/${userInfo?.user?.backgroundphoto}`} alt="" />
        ...
        <div className='diva-three'>
          <div className='diva-two'><img className='cover-two' src={`http://localhost:5000/${userInfo?.user?.profilephoto}`} alt="" /><br></br>
                ...
                return (
                  <SwiperSlide key={index}>
                    <div style={{ display: 'inline', borderRadius: 20 }}>
                      <img style={{ width: 400, height: 500 }} src={`http://localhost:5000/${item.image}`} alt='imag1' />
                    </div>
                  </SwiperSlide>
                )
              })
